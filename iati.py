...
class IATIdata:
    ...
    def process(self):
        ...
        # remove unnecssary single/double quotes from transaction_ref
        tbl_implementors['transaction_ref'] = tbl_implementors['transaction_ref'].astype(str).str.replace(',', ' ')
        tbl_implementors['transaction_ref'] = tbl_implementors['transaction_ref'].astype(str).str.replace('"', '')
        tbl_implementors['transaction_ref'] = tbl_implementors['transaction_ref'].astype(str).str.replace("'", '')
