...
if __name__ == "__main__":
    ...
    # ids_and_yrs.to_sql(name='iati_activity_over_timeline', schema='dbo', if_exists='append', index=False,
    ...
    #
    # txn_data.to_sql(name='iati_txn', schema='dbo', if_exists='append', index=False,
    ...
    # txn_raw.to_sql(name='iati_txn', schema='dbo', if_exists='append', index=False,
    #                index_label=["iati_identifier",
    #                             "transaction_type",
    #                             "transaction_date",
    #                             "default_currency",
